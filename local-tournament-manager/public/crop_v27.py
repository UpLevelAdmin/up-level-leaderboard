...
def crop_grid(image_path):
    print(f"Processing V27: {image_path}")
...
target_file = "/Users/chawanutcharoenthammachoke/Documents/Cursor/up-level-leaderboard/local-tournament-manager/public/assets/uplevel-icons/source-grids/uplevel_meta_grid_9x9_v27_eevee_party_1766120234263.png"
