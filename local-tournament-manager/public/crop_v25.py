...
def crop_grid(image_path):
    print(f"Processing V25: {image_path}")
...
target_file = "/Users/chawanutcharoenthammachoke/Documents/Cursor/up-level-leaderboard/local-tournament-manager/public/assets/uplevel-icons/source-grids/uplevel_meta_grid_9x9_v25_rogue_challenge_1766116569136.png"
