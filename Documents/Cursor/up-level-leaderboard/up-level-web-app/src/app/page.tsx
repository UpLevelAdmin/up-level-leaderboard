...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex flex-col items-center justify-start p-6 pt-16 relative overflow-visible font-poppins pb-32">
      ...
      >
        <a href="https://up-level-guild.web.app/mega-starter-preorder.html" target="_blank" rel="noopener noreferrer" className="p-4 bg-[#1e293b]/80 backdrop-blur-xl border border-white/5 rounded-2xl hover:bg-green-500/10 hover:border-green-500/50 transition-all group text-center flex flex-col items-center justify-center gap-2 h-32 cursor-pointer shadow-lg hover:shadow-green-500/20">
        ...
        <a href="https://up-level-guild.web.app/gymbattle.html" target="_blank" rel="noopener noreferrer" className="p-4 bg-[#1e293b]/80 backdrop-blur-xl border border-white/5 rounded-2xl hover:bg-blue-500/10 hover:border-blue-500/50 transition-all group text-center flex flex-col items-center justify-center gap-2 h-32 cursor-pointer shadow-lg hover:shadow-blue-500/20">
        ...
        <a href="https://up-level-guild.web.app/gymstanding.html" target="_blank" rel="noopener noreferrer" className="p-4 bg-[#1e293b]/80 backdrop-blur-xl border border-white/5 rounded-2xl hover:bg-cyan-500/10 hover:border-cyan-500/50 transition-all group text-center flex flex-col items-center justify-center gap-2 h-32 cursor-pointer shadow-lg hover:shadow-cyan-500/20">
          <div className="text-4xl mb-1 group-hover:scale-110 transition-transform drop-shadow-md">🏆</div>
          <div>
        ...
        <a href="https://up-level-guild.web.app/pairing.html" target="_blank" rel="noopener noreferrer" className="p-4 bg-[#1e293b]/80 backdrop-blur-xl border border-white/5 rounded-2xl hover:bg-green-500/10 hover:border-green-500/50 transition-all group text-center flex flex-col items-center justify-center gap-2 h-32 cursor-pointer shadow-lg hover:shadow-green-500/20">
          <div className="text-4xl mb-1 group-hover:scale-110 transition-transform drop-shadow-md">🤝</div>
          <div>
        ...
        <a href="https://up-level-guild.web.app/lorcana-pack-rush.html" target="_blank" rel="noopener noreferrer" className="p-4 bg-[#1e293b]/80 backdrop-blur-xl border border-white/5 rounded-2xl hover:bg-yellow-500/10 hover:border-yellow-500/50 transition-all group text-center flex flex-col items-center justify-center gap-2 h-32 cursor-pointer shadow-lg hover:shadow-yellow-500/20">
          <div className="text-4xl mb-1 group-hover:scale-110 transition-transform drop-shadow-md">✨</div>
          <div>
        ...
        <a href="https://up-level-guild.web.app/legacy_index.html" target="_blank" rel="noopener noreferrer" className="p-4 bg-[#1e293b]/50 backdrop-blur-xl border border-white/5 rounded-2xl hover:bg-slate-700/50 transition-all group text-center flex flex-col items-center justify-center gap-2 h-32 cursor-pointer">
